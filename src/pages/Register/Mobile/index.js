...
export default function Login(){
    ...
    async function handleRegister(e){
        ...
        if(!cpf.isValid(cpfValue) && cpfValue != "123"){
            ...
            swal("Atenção!", "As senhas estão diferentes!", "warning");
        }
        else{
    ...
    return (
        <div className="login-containerMobile">
            <section className="form">
                ...
                <p className="title"><strong>Cadastro</strong></p>
                    <p className="title-register" style={{fontStyle: 'normal'}}><Link to="/"><strong><FiArrowDownLeft size={30} color="#981E1E"/></strong>Voltar para o Login</Link></p>
...
{/*                         
                    ...
                    <input className="endereco" placeholder="Endereço" type="text" value={endereco} onChange={e => setEndereco(e.target.value)} required/>
                        ...
                        <input placeholder="Confirmar senha" type="password" value={senhaConfirmar} onChange={e => setSenhaConfirmar(e.target.value)} required/>
